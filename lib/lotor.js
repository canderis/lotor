...
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Bif; });
class Bif {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Erf; });
class Erf {
    constructor(directory, fs, game){
        this.fs = fs;
        this.game = game;
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: lotor */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lotor", function() { return lotor; });
/* harmony import */ var _bif_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bif.js */ "./src/bif.js");
/* harmony import */ var _erf_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./erf.js */ "./src/erf.js");
...
class lotor{
    constructor(directory, fs){
        ...
        me.fs = fs;
        me.bif = new _bif_js__WEBPACK_IMPORTED_MODULE_0__["default"](directory, fs, me);
        me.erf = new _erf_js__WEBPACK_IMPORTED_MODULE_1__["default"](directory, fs, me);
